...
<!-- Tab links -->
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Individuals')">Ecology of Individuals</button>
  <button class="tablinks" onclick="openCity(event, 'Ecosystems')">Ecology of Ecosystems</button>
  <button class="tablinks" onclick="openCity(event, 'Theory')">Theoretical Ecology</button>
</div>
